                    ...
                    <div class="page-title">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura36.png" data-bs-toggle="modal" data-bs-target="#Imagem36">
                                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" width="440" src="imagens/Figura36.png" alt="Alt da imagem fica aqui">
                                    </a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura37.png" data-bs-toggle="modal" data-bs-target="#Imagem37">
                                        <img class="img-fluid wow fadeInRight" data-wow-delay="1.0s" width="450" src="imagens/Figura37.png" alt="Alt da imagem fica aqui">
                                    </a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura38.png" data-bs-toggle="modal" data-bs-target="#Imagem38">
                                        <img class="img-fluid wow fadeInLeft mt-5" data-wow-delay="1.5s" width="350" src="imagens/Figura38.png" alt="Alt da imagem fica aqui">
                                    </a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura39.png" data-bs-toggle="modal" data-bs-target="#Imagem39">
                                        <img class="img-fluid wow fadeInDown mt-5" data-wow-delay="2.0s" src="imagens/Figura39.png" alt="Alt da imagem fica aqui">
                                    </a>
                        ...
                        <div class="ImportanteCaixa">
                            ...
                            <div class="ImportanteTexto">
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border border-warning pt-3 pb-3">
                                ...
                                <p>Além da riqueza de vida, a vegetação de mangue serve para fixar as terras, impedindo assim a erosão e ao mesmo tempo estabilizando a costa. As raízes do mangue funcionam como filtros na retenção dos sedimentos. <strong>Veja este experimento a seguir</strong>:</p>
                        ...
                        <div class="FiqueAtentoCaixa">
                            ...
                            <div class="FiqueAtentoTexto">
                                <p><strong>O manguezal produz mais de 95% do alimento que o ser humano captura do mar.</strong> Sua preservação é vital para a subsistência das comunidades pesqueiras que vivem em seu entorno.</p>
                            </div>
                        </div>
                        <br><br>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="text-center">
                                            <a href="imagens/Figura40.png" data-bs-toggle="modal" data-bs-target="#Imagem40">
                                                <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" width="400" src="imagens/Figura40.png" alt="Alt da imagem fica aqui">
                                            </a>
                                            <p class="FonteFigura"> Ubaia, fruto típico de dunas. <br>Foto: wikipedia. </p>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="text-center">
                                            <a href="imagens/Figura41.png" data-bs-toggle="modal" data-bs-target="#Imagem41">
                                                <img class="img-fluid wow fadeInDown" data-wow-delay="1.0s" width="450" src="imagens/Figura41.png" alt="Alt da imagem fica aqui">
                                            </a>
                                            <p class="FonteFigura"> Calango do rabo azul, vive sob a vegetação das dunas. <br>Foto: Pinterest.</p>
                                        </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura42.png" data-bs-toggle="modal" data-bs-target="#Imagem42">
                                        <img class="img-fluid wow fadeInLeft" data-wow-delay="0.5s" width="500" src="imagens/Figura42.png" alt="Alt da imagem fica aqui">
                                    </a>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="text-center">
                                    <a href="imagens/Figura43.png" data-bs-toggle="modal" data-bs-target="#Imagem43">
                                        <img class="img-fluid wow fadeInRight" data-wow-delay="1.0s" width="500" src="imagens/Figura43.png" alt="Alt da imagem fica aqui">
                                    </a>
